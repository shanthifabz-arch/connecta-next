...
export default function TranslationEditor() {
  ...
  const handleSave = async () => {
    try {
      if (Object.keys(translations).length === 0) {
        setSaveStatus("âš ï¸ No translations to save.");
        return;
      }
  ...
  const handleExportExcel = () => {
    if (Object.keys(englishBase).length === 0) {
      setSaveStatus("âš ï¸ English base translations missing.");
      return;
    }
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full border">
            ...
            <tbody>
              {englishBase && Object.keys(englishBase).length > 0 ? (
                ...
                <tr>
                  <td colSpan={3} className="text-center py-4">
                    No translations found or loading...
                  </td>
                </tr>
              )}
            </tbody>

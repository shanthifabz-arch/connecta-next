...
export default function B2CForm() {
  ...
  { name: "", desc: "", mrp: "", price: "", available: false }
]);
  ...
  const updateProduct = <K extends keyof Product>(index: number, key: K, value: Product[K]) => {
  ...
  return (
    <form className="w-full max-w-3xl mx-auto bg-white p-4 rounded shadow-md overflow-y-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
       ...
       <input type="text" placeholder="Short Company Name (≤ 10 char)" className="input" />

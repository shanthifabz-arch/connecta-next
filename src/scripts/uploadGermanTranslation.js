...
function uploadTranslations() {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, fileBuffer, workbook, sheet, rows, translations_1, languageCode, error, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    filePath = './data/translation_german.xlsx';
                ...
                case 1:
                    ...
                    rows.forEach(function (row) {
                        if (row.Key && row.German) {
                            translations_1[row.Key] = row.German;
                        }
                    });
                    languageCode = 'de';
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error('Error reading or uploading file:', err_1);
                    return [3 /*break*/, 4];
